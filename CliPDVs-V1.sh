...
rm -rf CliPDVs-V1.sh && wget https://raw.githubusercontent.com/nilsonlinux/CliPDVs/master/CliPDVs-V1.sh && chmod +x ./CliPDVs-V1.sh
  echo -e " ${g}Atualização concluída${enda} ..."; sleep 5 && clear
  echo && echo -en " ${g}Sistema atualizado${enda}
  ${y}Digite Enter para ir para o menu principal${enda}"
  read input
}
# Script Initiation
logo && echo -e " ${y}Verificando atualizações...${endc}" && sleep 1
...
rcx01 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Reiniciando${endc} ${y}Caixa rápido 01${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.131 "reboot"; saidarpdv " ${c}Caixa rápido 01${endc}" ;;
...
rcx03 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Reiniciando${endc} ${y}Caixa rápido 03${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.123 "reboot"; saidarpdv " ${c}Caixa rápido 03${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; reiniciarpdvs ;;
...
rcx04 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Reiniciando${endc} ${y}Caixa rápido 04${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.124 "reboot"; saidarpdv " ${c}Caixa rápido 04${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; reiniciarpdvs ;;
...
reiniciarpdvs () {
  ...
  echo -e "      1)    ${p}Terminal 102${enda} - ${a}Caixa rápido 01${enda} - ${v}192.168.3.131${enda}
      ...
      3)    ${p}Terminal 104${enda} - ${a}Caixa rápido 03${enda} - ${v}192.168.3.123${enda}
      4)    ${p}Terminal 105${enda} - ${a}Caixa rápido 04${enda} - ${v}192.168.3.124${enda}
...
acx01 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa rápido 01${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.131 "it-update-pdv.sh"; saidaapdv " ${c}Caixa rápido 01${endc}" ;;
...
acx02 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa rápido 02${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.122 "it-update-pdv.sh"; saidaapdv " ${c}Caixa rápido 02${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx03 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa rápido 03${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.123 "it-update-pdv.sh"; saidaapdv " ${c}Caixa rápido 03${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx04 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa rápido 04${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.124 "it-update-pdv.sh"; saidaapdv " ${c}Caixa rápido 04${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx05 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 05${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.25 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 05${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx06 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 06${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.102 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 06${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx07 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa rápido 07${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.103 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 07${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx08 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 08${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.104 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 08${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx09 () {
  logo
  echo -e " ${y}Confirme a atualização do Caixa 09${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 09${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.139 "it-update-pdv.sh"; saidaapdv " ${c}Caixa rápido 09${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx10 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 10${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.105 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 10${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx11 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 11${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.107 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 11${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx12 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 12${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.120 "rebooit-update-pdv.sht"; saidaapdv " ${c}Caixa 12${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx13 () {
  logo
  echo -e " ${y}Confirme a atualização do Caixa 13${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 13${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.106 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 13${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx14 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 14${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.110 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 14${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx15 () {
  logo
  echo -e " ${y}Confirme a atualização do Caixa 15${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 15${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.11 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 15${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; acx15 ;;
  esac
}
###############################################################################
###############################################################################
acx16 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa rápido 01${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.112 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 16${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx17 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 17${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.113 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 17${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; rcx17 ;;
  esac
}
...
acx18 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 18${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.114 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 18${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx19 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 19${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.115 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 19${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx20 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 20${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.116 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 20${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx21 () {
  logo
  echo -e " ${y}Confirme a atualização do Caixa 22${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Reiniciando${endc} ${y}Caixa 22${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.55 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 22${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; acx21 ;;
  esac
}
###############################################################################
###############################################################################
acx22 () {
  logo
  echo -e " ${y}Confirme a atualização do Terminal 123 Lanchonete${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Terminal 123 Lanchonete${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.59 "it-update-pdv.sh"; saidaapdv " ${c}Terminal 123 Lanchonete${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; acx22 ;;
  esac
}
###############################################################################
###############################################################################
acx23 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Eletro 01${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.117 "it-update-pdv.sh"; saidaapdv " ${c} da Lanchonete${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx24 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa Eletro 02${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.225 "it-update-pdv.sh"; saidaapdv " ${c}Eletro 02${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx25 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 21${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.119 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 21${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acx26 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa reserva${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.138 "it-update-pdv.sh"; saidaapdv " ${c}Caixa reserva${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; acx26 ;;
  esac
}
###############################################################################
###############################################################################
acx27 () {
  logo
  echo -e " ${y}Confirme a atualização do Caixa 27${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Caixa 27${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.129 "it-update-pdv.sh"; saidaapdv " ${c}Caixa 27${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
acxtodos () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}atualização${endc} ${y}Todos os Caixas${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.131 "it-update-pdv.sh"; saidaapdv " ${c}Caixa rápido 01${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizarpdvs ;;
...
aicx01 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa rápido 01${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa rápido 01${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.131 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa rápido 01${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx01 ;;
  esac
}
###############################################################################
###############################################################################
aicx02 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa rápido 02${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa rápido 02${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.122 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa rápido 02${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx02 ;;
  esac
}
###############################################################################
###############################################################################
aicx03 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa rápido 03${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa rápido 03${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.123 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa rápido 03${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx03 ;;
  esac
}
###############################################################################
###############################################################################
aicx04 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa rápido 04${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa rápido 04${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.124 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa rápido 04${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx04 ;;
  esac
}
###############################################################################
###############################################################################
aicx05 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 05${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 05${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.25 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 05${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx05 ;;
  esac
}
###############################################################################
###############################################################################
aicx06 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 06${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 06${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.102 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 06${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx06 ;;
  esac
}
###############################################################################
###############################################################################
aicx07 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa rápido 07${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa rápido 07${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.103 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 07${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx07 ;;
  esac
}
###############################################################################
###############################################################################
aicx08 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 08${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 08${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.104 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 08${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx08 ;;
  esac
}
###############################################################################
###############################################################################
aicx09 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 09${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.139 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa rápido 09${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx09 ;;
  esac
}
###############################################################################
###############################################################################
aicx10 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 10${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 10${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.105 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 10${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx10 ;;
  esac
}
###############################################################################
###############################################################################
aicx11 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 11${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 11${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.107 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 11${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx11 ;;
  esac
}
###############################################################################
###############################################################################
aicx12 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 12${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 12${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.120 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 12${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx12 ;;
  esac
}
###############################################################################
###############################################################################
aicx13 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 13${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.106 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 13${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx13 ;;
  esac
}
###############################################################################
###############################################################################
aicx14 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 14${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 14${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.110 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 14${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx14 ;;
  esac
}
###############################################################################
###############################################################################
...
aicx16 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 16${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa rápido 01${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.112 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 16${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx16 ;;
  esac
}
###############################################################################
###############################################################################
aicx17 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 17${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 17${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.113 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 17${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx17 ;;
  esac
}
###############################################################################
###############################################################################
aicx18 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa rápido 18${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 18${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.114 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 18${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx18 ;;
  esac
}
###############################################################################
###############################################################################
aicx19 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 19${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 19${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.115 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 19${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx19 ;;
  esac
}
###############################################################################
###############################################################################
aicx20 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 20${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 20${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.116 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 20${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx20 ;;
  esac
}
###############################################################################
###############################################################################
aicx21 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 22${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.55 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 22${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
...
aicx22 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Terminal 123 Lanchonete${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.59 "it-update-imagens.sh"; saidaaipdv " ${c}Terminal 123 Lanchonete${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
...
aicx23 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Eletro 01${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Eletro 01${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.117 "it-update-imagens.sh"; saidaaipdv " ${c} da Lanchonete${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx23 ;;
  esac
}
###############################################################################
###############################################################################
aicx24 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa Eletro 02${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa Eletro 02${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.225 "it-update-imagens.sh"; saidaaipdv " ${c}Eletro 02${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx24 ;;
  esac
}
###############################################################################
###############################################################################
aicx25 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa 21${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 21${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.119 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 21${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx25 ;;
  esac
}
###############################################################################
###############################################################################
aicx26 () {
  logo
  echo -e " ${y}Confirme a atualização de imagem do Caixa reserva${endc}" && echo
  echo -e " ${bu}Esta operação não pode ser desfeita.${enda}"
  echo && echo -en " ${y}Deseja continuar? {s/n}${endc} "
  read option
  case $option in
...
aicx27 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando${endc} ${y}Caixa 27${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.129 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa 27${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicx27 ;;
  esac
}
###############################################################################
###############################################################################
...
aicxtodos () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Atualizando imagem de ${endc} ${y}Todos os Caixas${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.131 "it-update-imagens.sh"; saidaaipdv " ${c}Caixa rápido 01${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; atualizaripdvs ;;
    *) echo -e " \"$option\"  ${r}Comando inválido!${endc}"; sleep 1; aicxtodos ;;
  esac
}
###############################################################################
# Comando executado
...
rmxpos03 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Reiniciando MaxiPOS${endc} ${y}Caixa rápido 03${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.123 "it-update-imagens.sh"; saidarmxpos " ${c}Caixa rápido 03${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; reiniciarmxpos ;;
...
rmxpos04 () {
  ...
  read option
  case $option in
    s) echo && echo -e " ${r}Reiniciando MaxiPOS${endc} ${y}Caixa rápido 04${endc}"; sshpass -p 1 ssh -o "StrictHostKeyChecking no" root@192.168.3.124 "it-update-imagens.sh"; saidarmxpos " ${c}Caixa rápido 04${endc}" ;;
    n) echo -e " ${y}OK. Retornando para o menu anterior${end}"; sleep 1; reiniciarmxpos ;;

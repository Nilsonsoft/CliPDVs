...
echo -e "\033[0;32m |---------[\033[0;33m 7 \033[0m\033[0;32m]\033[0m\033[0m \033[1;32mAtualizar CliPDVs\033[0m  \033[0;32m             | \033[0m"
echo -e "\033[0;32m |-----------------------------------------------|\033[0m"
...
5) ./CliPDVs/ramais_ti.sh;;
6) ./CliPDVs/ids_balanca.sh;;
7) ./CliPDVs/AtualizadorCliPDVs.sh;;
